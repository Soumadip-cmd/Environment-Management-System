                ...
                <ul className="navbar-nav justify-content-start flex-grow-1 pe-3">
                  <li className="nav-item">
                    ...
                    >
                      <svg
                        ...
                        height="23"
                        fill="white"
                        className="bi bi-house-door m-2"
                        viewBox="0 0 16 16"
                      >
                  ...
                  <li className="nav-item">
                    ...
                    >
                      <svg
                        ...
                        height="23"
                        fill="currentColor"
                        className="bi bi-person-lines-fill m-2"
                        viewBox="0 0 16 16"
                      >
                  ...
                  <li className="nav-item dropdown">
                    ...
                    <ul className="dropdown-menu dropdown-menu-dark">
                      <li>
                        <Link className="dropdown-item" to="/garbage">
                          Garbage Management
                        </Link>
                      </li>
                      <li>
                        <hr className="dropdown-divider" />
                        <Link className="dropdown-item" to="/airquality">
                  ...
                  <li className="nav-item">
                    <Link
                      ...
                      to="/community"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" className="bi bi-award m-2" viewBox="0 0 16 16">
                  ...
                  <li className="nav-item">
                    ...
                    >
                      <svg
                        ...
                        height="23"
                        fill="currentColor"
                        className="bi bi-briefcase-fill m-2"
                        viewBox="0 0 16 16"
                      >
